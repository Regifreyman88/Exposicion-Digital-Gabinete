...
# --- CREDENCIALES DIRECTAS (MÉTODO DE PRUEBA) ---
# Se construye el diccionario de credenciales directamente aquí
creds_dict = {
...
def connect_to_google_sheets():
    try:
        ...
        st.error(f"Error de autenticación directo en el código: {e}")
        return None
...
if client:
    df = load_data(client)
    if not df.empty:
        # --- NOMBRES EXACTOS DE LAS COLUMNAS DE TU FORMULARIO ---
